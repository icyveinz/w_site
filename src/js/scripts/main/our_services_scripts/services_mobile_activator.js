...
function services_mobile_activator() {
    ...
    layout_trigger_node.forEach((element, index) => {
        ...
        layout_timeline
            ...
            .from(element.querySelector('p'), comment_animation_template_mobile(index));
    })
}

export default services_mobile_activator;